...
public class RegionalAirport extends Airport {
	...
	public RegionalAirport(int ID, int x, int y, double fuelCost, double operationFee, int aircraftCapacity) {
	...
	public double departAircraft(Aircraft aircraft) {
		...
		return this.getOperationFee() * fullnessCoeff * weightRatio * 1.2;
	}
	...
	public double landAircraft(Aircraft aircraft) {
		...
		return this.getOperationFee() * fullnessCoeff * weightRatio * 1.3;
	}
}
