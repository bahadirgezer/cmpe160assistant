...
public class EconomyPassenger extends Passenger {
	...
	protected double calculateTicketPrice(Airport toAirport, double aircraftTypeMultiplier) {
		...
		double ticketPrice = 0.6*airportMultiplier*seatMultiplier*aircraftTypeMultiplier*connectionMultiplier*toAirport.getDistance(getDestinations().get(previousDisembarkIndex));
