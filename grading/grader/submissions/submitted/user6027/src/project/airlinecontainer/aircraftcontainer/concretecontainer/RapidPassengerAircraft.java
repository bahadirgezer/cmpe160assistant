...
public class RapidPassengerAircraft extends PassengerAircraft{
	...
	public RapidPassengerAircraft(double operationfee, Airport currentAirport, double weigth, double maxWeight, double floorarea, double fuelCapacity, double fuelConsumption, double aircraftTypeMultiplier) {
