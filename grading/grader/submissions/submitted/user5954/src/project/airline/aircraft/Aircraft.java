...
public abstract class Aircraft implements AircraftInterface {
    ...
    public void setFuel(double amount) { this.fuel = amount; }
    ...
    public double getFlightCost(Airport toAirport){
        ...
        double landingCost = toAirport.getLandingCost(this);
        double departureCost = currentAirport.getDepartureCost(this);
        double flightOperationCost = distance * getFullness() * getFlightCostConstant();
