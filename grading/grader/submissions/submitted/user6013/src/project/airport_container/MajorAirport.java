...
public class MajorAirport extends Airport {
	...
	public MajorAirport(int a,double b,double c,double d,double e,int f){
		super(a,b,c,d,e,f,2);
	}
	@Override
	...
	public double getDepartureCost(Aircraft aircraft) {
		// TODO Auto-generated method stub
		return super.operationFee*0.6*Math.pow(Math.E, getaircraftRatio())*(aircraft.getWeightRatio())*0.9;
	}
	@Override
	public double getLandingCost(Aircraft aircraft) {
		// TODO Auto-generated method stub
		return super.operationFee*0.6*Math.pow(Math.E, getaircraftRatio())*(aircraft.getWeightRatio());
	}
}
