...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		FileInputStream file = new FileInputStream("./src/project/executableContainer/input0.txt");
		...
		File outputFile = new File("./src/project/executableContainer/output.txt");
