...
public class FirstClassPassenger extends Passenger {
	private final double passengerMultiplier = 3.2;
	public FirstClassPassenger(long ID, double weight, int baggageCount, ArrayList<Integer> destinations,Airport currentAirport) {
