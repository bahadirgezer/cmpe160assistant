...
public class RegionalAirport extends Airport {
    ...
    public RegionalAirport(long id, double x, double y, int aircraftCapacity, double fuelCost, double operationFee, int type) {
    ...
    public double getDepartureCost(Aircraft aircraft) {
        ...
        return operationFee * fullnessCoefficient() * aircraft.getWeightRatio() * 1.20;
    }
    ...
    public double getLandingCost(Aircraft aircraft) {
        return operationFee * fullnessCoefficient() * aircraft.getWeightRatio() * 1.30;
    }
}
