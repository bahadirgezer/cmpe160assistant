...
public abstract class PassengerAircraft extends Aircraft implements PassengerInterface {
	...
	public double getFullness() {
		return (this.getEconomySeats() + this.getBusinessSeats() + this.getFirstClassSeats()) / (this.getOccupiedEconomySeats() * this.getOccupiedBusinessSeats() * this.getOccupiedFirstClassSeats());
	}
