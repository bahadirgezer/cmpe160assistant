...
public class MajorAirport extends Airport {
	...
	public double departAircraft(Aircraft aircraft) {
		...
		double departureFee = operationFee * aircraft_weight_ratio * fullness_coefficient * 0.9;
		return departureFee;
	}
	...
	public double landAircraft(Aircraft aircraft) {
		...
		double fullness_coefficient = 0.6 * java.lang.Math.exp(aircraft_ratio);
		double aircraft_weight_ratio = aircraft.getWeightRatio();
		double landingFee = operationFee * aircraft_weight_ratio * fullness_coefficient * 1.0;
