...
public class EconomyPassenger extends Passenger{
	...
	private double airport_multiplier=1.0;
	...
	protected double calculateTicketPrice(Airport toAirport, double aircraftTypeMultiplier) {
		...
		return distance*0.6*airport_multiplier*aircraftTypeMultiplier*connectionMultiplier*seatMultiplier*(1+0.05*getbaggageCount());			
	}
