...
public class JetPassengerAircraft extends PassengerAircraft {
	...
	public JetPassengerAircraft(Airport currentAirport, double weight, double maxWeight, double fuelWeight, double fuel,
			double fuelCapacity, int economySeats, int businessSeats, int firstClassSeats, int occupiedEconomySeats,
			int occupiedBusinessSeats, int occupiedFirstClassSeats, double floorArea,double operationFee) {
