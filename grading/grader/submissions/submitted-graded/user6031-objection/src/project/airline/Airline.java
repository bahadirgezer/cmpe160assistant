...
//				this.loadPassengers(aircraftIndex, currentAirport, toAirport);
//				int num=0;
//				while (currentAirport.equals(toAirport) ==false) {
//					num++;
//					if (num==100) {break;}
//					if (this.intermediate(currentAirport, toAirport) != currentAirport) {
//
//						Airport toAirport1 = this.intermediate(currentAirport, toAirport);
//						if (this.fueling(aircraftIndex, toAirport1)) {
//							
//							if (this.fly(toAirport1, aircraftIndex)) {
//								visited.add(toAirport1);
//								if(toAirport1.getDistance(toAirport)<14000) {
//									break;
//								}
//								flightnum++;
////							System.out.println("______________________" + flightnum);
//								currentAirport = toAirport1;
//								
//							}
//						}
//					}
