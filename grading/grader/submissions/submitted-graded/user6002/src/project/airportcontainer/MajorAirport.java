...
public class MajorAirport extends Airport{
	public MajorAirport(int airportType, int ID, double x, double y, double fuelCost, double operationFee, int aircraftCapacity) {
	...
	public double landAircraft(Aircraft aircraft) {
		...
		double fullnessCoefficient = 0.6 * Math.pow(Math.E, aircraftRatio);
		double aircraftWeightRatio = aircraft.getWeightRatio();
		double landingFee = operationFee * aircraftWeightRatio * fullnessCoefficient;
