...
public class BusinessPassenger extends Passenger{
	public final double passengerMultiplier = 1.2;
	
	public BusinessPassenger(int passengerType, long ID, double weight, int baggageCount, ArrayList<Airport> destinations) {
